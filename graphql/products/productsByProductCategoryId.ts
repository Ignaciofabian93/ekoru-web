...
export const GET_PRODUCTS_BY_PRODUCT_CATEGORY_ID = gql`
  query ProductsByProductCategory($productCategoryId: ID!) {
    productsByProductCategory(productCategoryId: $productCategoryId) {
      id
      sku
      barcode
      color
