...
export const GET_PRODUCTS_BY_DEPARTMENT_CATEGORY_ID = gql`
  query ProductsByDepartmentCategory($departmentCategoryId: ID!) {
    productsByDepartmentCategory(departmentCategoryId: $departmentCategoryId) {
      id
      sku
      barcode
      color
